...
export function getProperties(_values: PluggableListViewPreviewProps, defaultProperties: Properties/*, target: Platform*/): Properties {
...
// export function getCustomCaption(values: PluggableListViewPreviewProps, platform: Platform): string {
//     return "PluggableListView";
// }
